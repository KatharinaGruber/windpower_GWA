...
stats_USAm = pd.DataFrame({'ERA5':stats(cf_USAm.ERA5['2010':],cf_USAm.wp_obs['2010':],False),
                           'ERA5_GWA':stats(cf_USAm.ERA5_GWA['2010':],cf_USAm.wp_obs['2010':],False),
                           'MERRA2':stats(cf_USAm.MERRA2['2010':],cf_USAm.wp_obs['2010':],False),
                           'MERRA2_GWA':stats(cf_USAm.MERRA2_GWA['2010':],cf_USAm.wp_obs['2010':],False),
                           'obs':[np.nan,np.nan,np.nan,cf_USAm.wp_obs['2010':].mean()]},
                          index = ['cor','rmse','mbe','avg'])
stats_USAm_r = pd.DataFrame({'ERA5':stats(cf_USAm.ERA5['2010':],cf_USAm.wp_obs['2010':]),
                             'ERA5_GWA':stats(cf_USAm.ERA5_GWA['2010':],cf_USAm.wp_obs['2010':]),
                             'MERRA2':stats(cf_USAm.MERRA2['2010':],cf_USAm.wp_obs['2010':]),
                             'MERRA2_GWA':stats(cf_USAm.MERRA2_GWA['2010':],cf_USAm.wp_obs['2010':]),
                             'obs':[np.nan,np.nan,np.nan,round(cf_USAm.wp_obs['2010':].mean(),2)]},
                            index = ['cor','rmse','mbe','avg'])
# save statistical results
stats_USAm.to_csv(results_pathg+'/stats_USAm2010.csv')
stats_USAm_r.to_csv(results_pathg+'/stats_USAm_r2010.csv',sep=';')
...
for (state_reg,region,cap_regm) in zip(*(states_reg,regions,caps_reg)):
    ...
    # Analyse
    stats_regm = pd.DataFrame({'ERA5':stats(cf_regm.ERA5['2010':],cf_regm.wp_obs['2010':],False),
                               'ERA5_GWA':stats(cf_regm.ERA5_GWA['2010':],cf_regm.wp_obs['2010':],False),
                               'MERRA2':stats(cf_regm.MERRA2['2010':],cf_regm.wp_obs['2010':],False),
                               'MERRA2_GWA':stats(cf_regm.MERRA2_GWA['2010':],cf_regm.wp_obs['2010':],False),
                               'obs':[np.nan,np.nan,np.nan,cf_regm.wp_obs['2010':].mean()]},
                              index = ['cor','rmse','mbe','avg'])
    stats_regm_r = pd.DataFrame({'ERA5':stats(cf_regm.ERA5['2010':],cf_regm.wp_obs['2010':]),
                               'ERA5_GWA':stats(cf_regm.ERA5_GWA['2010':],cf_regm.wp_obs['2010':]),
                               'MERRA2':stats(cf_regm.MERRA2['2010':],cf_regm.wp_obs['2010':]),
                               'MERRA2_GWA':stats(cf_regm.MERRA2_GWA['2010':],cf_regm.wp_obs['2010':]),
                               'obs':[np.nan,np.nan,np.nan,round(cf_regm.wp_obs['2010':].mean(),2)]},
                              index = ['cor','rmse','mbe','avg'])
...
# save statistical results
stats_regionsm.to_csv(results_pathg+'/stats_regionsm2010.csv')
stats_regionsm_r.to_csv(results_pathg+'/stats_regionsm_r2010.csv',sep=';')
...
for state in np.array(states_USAm)[[s in turb_mer.state.unique() for s in states_USAm]]:
    ...
    # Analyse
    stats_stm = pd.DataFrame({'ERA5':stats(cf_stm.ERA5['2010':],cf_stm.wp_obs['2010':],False),
                              'ERA5_GWA':stats(cf_stm.ERA5_GWA['2010':],cf_stm.wp_obs['2010':],False),
                              'MERRA2':stats(cf_stm.MERRA2['2010':],cf_stm.wp_obs['2010':],False),
                              'MERRA2_GWA':stats(cf_stm.MERRA2_GWA['2010':],cf_stm.wp_obs['2010':],False),
                              'obs':[np.nan,np.nan,np.nan,cf_stm.wp_obs['2010':].mean()]},
                             index = ['cor','rmse','mbe','avg'])
    stats_stm_r = pd.DataFrame({'ERA5':stats(cf_stm.ERA5['2010':],cf_stm.wp_obs['2010':]),
                                'ERA5_GWA':stats(cf_stm.ERA5_GWA['2010':],cf_stm.wp_obs['2010':]),
                                'MERRA2':stats(cf_stm.MERRA2['2010':],cf_stm.wp_obs['2010':]),
                                'MERRA2_GWA':stats(cf_stm.MERRA2_GWA['2010':],cf_stm.wp_obs['2010':]),
                                'obs':[np.nan,np.nan,np.nan,cf_stm.wp_obs['2010':].mean()]},
                              index = ['cor','rmse','mbe','avg'])
...
# save statistical results
stats_statesm.to_csv(results_pathg+'/stats_statesm2010.csv')
stats_statesm_r.to_csv(results_pathg+'/stats_statesm_r2010.csv',sep=';')
...
# Analyse
stats_TXh = pd.DataFrame({'ERA5':stats(cf_TXh.ERA5['2010':],cf_TXh.wp_obs['2010':],False),
                          'ERA5_GWA':stats(cf_TXh.ERA5_GWA['2010':],cf_TXh.wp_obs['2010':],False),
                          'MERRA2':stats(cf_TXh.MERRA2['2010':],cf_TXh.wp_obs['2010':],False),
                          'MERRA2_GWA':stats(cf_TXh.MERRA2_GWA['2010':],cf_TXh.wp_obs['2010':],False),
                          'obs':[np.nan,np.nan,np.nan,cf_TXh.wp_obs['2010':].mean()]},
                         index = ['cor','rmse','mbe','avg'])
stats_TXh_r = pd.DataFrame({'ERA5':stats(cf_TXh.ERA5['2010':],cf_TXh.wp_obs['2010':]),
                            'ERA5_GWA':stats(cf_TXh.ERA5_GWA['2010':],cf_TXh.wp_obs['2010':]),
                            'MERRA2':stats(cf_TXh.MERRA2['2010':],cf_TXh.wp_obs['2010':]),
                            'MERRA2_GWA':stats(cf_TXh.MERRA2_GWA['2010':],cf_TXh.wp_obs['2010':]),
                            'obs':[np.nan,np.nan,np.nan,round(cf_TXh.wp_obs['2010':].mean(),2)]},
                           index = ['cor','rmse','mbe','avg'])
# save statistical results
stats_TXh.to_csv(results_pathg+'/stats_TXh2010.csv')
stats_TXh_r.to_csv(results_pathg+'/stats_TXh_r2010.csv',sep=';')
...
# Analyse
stats_TXd = pd.DataFrame({'ERA5':stats(cf_TXd.ERA5['2010':],cf_TXd.wp_obs['2010':],False),
                          'ERA5_GWA':stats(cf_TXd.ERA5_GWA['2010':],cf_TXd.wp_obs['2010':],False),
                          'MERRA2':stats(cf_TXd.MERRA2['2010':],cf_TXd.wp_obs['2010':],False),
                          'MERRA2_GWA':stats(cf_TXd.MERRA2_GWA['2010':],cf_TXd.wp_obs['2010':],False),
                          'obs':[np.nan,np.nan,np.nan,cf_TXd.wp_obs['2010':].mean()]},
                         index = ['cor','rmse','mbe','avg'])
stats_TXd_r = pd.DataFrame({'ERA5':stats(cf_TXd.ERA5['2010':],cf_TXd.wp_obs['2010':]),
                            'ERA5_GWA':stats(cf_TXd.ERA5_GWA['2010':],cf_TXd.wp_obs['2010':]),
                            'MERRA2':stats(cf_TXd.MERRA2['2010':],cf_TXd.wp_obs['2010':]),
                            'MERRA2_GWA':stats(cf_TXd.MERRA2_GWA['2010':],cf_TXd.wp_obs['2010':]),
                            'obs':[np.nan,np.nan,np.nan,round(cf_TXd.wp_obs['2010':].mean(),2)]},
                           index = ['cor','rmse','mbe','avg'])
# save statistical results
...
# Analyse
stats_BPAh = pd.DataFrame({'ERA5':stats(cf_BPAh.ERA5['2010':],cf_BPAh.wp_obs['2010':],False),
                          'ERA5_GWA':stats(cf_BPAh.ERA5_GWA['2010':],cf_BPAh.wp_obs['2010':],False),
                          'MERRA2':stats(cf_BPAh.MERRA2['2010':],cf_BPAh.wp_obs['2010':],False),
                          'MERRA2_GWA':stats(cf_BPAh.MERRA2_GWA['2010':],cf_BPAh.wp_obs['2010':],False),
                          'obs':[np.nan,np.nan,np.nan,cf_BPAh.wp_obs['2010':].mean()]},
                         index = ['cor','rmse','mbe','avg'])
stats_BPAh_r = pd.DataFrame({'ERA5':stats(cf_BPAh.ERA5['2010':],cf_BPAh.wp_obs['2010':]),
                            'ERA5_GWA':stats(cf_BPAh.ERA5_GWA['2010':],cf_BPAh.wp_obs['2010':]),
                            'MERRA2':stats(cf_BPAh.MERRA2['2010':],cf_BPAh.wp_obs['2010':]),
                            'MERRA2_GWA':stats(cf_BPAh.MERRA2_GWA['2010':],cf_BPAh.wp_obs['2010':]),
                            'obs':[np.nan,np.nan,np.nan,round(cf_BPAh.wp_obs['2010':].mean(),2)]},
                           index = ['cor','rmse','mbe','avg'])
# save statistical results
stats_BPAh.to_csv(results_pathg+'/stats_BPAh2010.csv')
stats_BPAh_r.to_csv(results_pathg+'/stats_BPAh_r2010.csv',sep=';')
...
stats_BPAd = pd.DataFrame({'ERA5':stats(cf_BPAd.ERA5,cf_BPAd.wp_obs,False),
                         ...
                         index = ['cor','rmse','mbe','avg'])
stats_BPAd_r = pd.DataFrame({'ERA5':stats(cf_BPAd.ERA5['2010':],cf_BPAd.wp_obs['2010':]),
                            'ERA5_GWA':stats(cf_BPAd.ERA5_GWA['2010':],cf_BPAd.wp_obs['2010':]),
                            'MERRA2':stats(cf_BPAd.MERRA2['2010':],cf_BPAd.wp_obs['2010':]),
                            'MERRA2_GWA':stats(cf_BPAd.MERRA2_GWA['2010':],cf_BPAd.wp_obs['2010':]),
                            'obs':[np.nan,np.nan,np.nan,round(cf_BPAd.wp_obs['2010':].mean(),2)]},
                           index = ['cor','rmse','mbe','avg'])
# save statistical results
stats_BPAd.to_csv(results_pathg+'/stats_BPAd2010.csv')
stats_BPAd_r.to_csv(results_pathg+'/stats_BPAd_r2010.csv',sep=';')
...
# Analyse
stats_BPAm = pd.DataFrame({'ERA5':stats(cf_BPAm.ERA5['2010':],cf_BPAm.wp_obs['2010':],False),
                          'ERA5_GWA':stats(cf_BPAm.ERA5_GWA['2010':],cf_BPAm.wp_obs['2010':],False),
                          'MERRA2':stats(cf_BPAm.MERRA2['2010':],cf_BPAm.wp_obs['2010':],False),
                          'MERRA2_GWA':stats(cf_BPAm.MERRA2_GWA['2010':],cf_BPAm.wp_obs['2010':],False),
                          'obs':[np.nan,np.nan,np.nan,cf_BPAm.wp_obs['2010':].mean()]},
                         index = ['cor','rmse','mbe','avg'])
stats_BPAm_r = pd.DataFrame({'ERA5':stats(cf_BPAm.ERA5['2010':],cf_BPAm.wp_obs['2010':]),
                            'ERA5_GWA':stats(cf_BPAm.ERA5_GWA['2010':],cf_BPAm.wp_obs['2010':]),
                            'MERRA2':stats(cf_BPAm.MERRA2['2010':],cf_BPAm.wp_obs['2010':]),
                            'MERRA2_GWA':stats(cf_BPAm.MERRA2_GWA['2010':],cf_BPAm.wp_obs['2010':]),
                            'obs':[np.nan,np.nan,np.nan,round(cf_BPAm.wp_obs['2010':].mean(),2)]},
                           index = ['cor','rmse','mbe','avg'])
# save statistical results
stats_BPAm.to_csv(results_pathg+'/stats_BPAm2010.csv')
stats_BPAm_r.to_csv(results_pathg+'/stats_BPAm_r2010.csv',sep=';')
...
# Analyse
stats_NEm = pd.DataFrame({'ERA5':stats(cf_NEm.ERA5['2010':],cf_NEm.wp_obs['2010':],False),
                          'ERA5_GWA':stats(cf_NEm.ERA5_GWA['2010':],cf_NEm.wp_obs['2010':],False),
                          'MERRA2':stats(cf_NEm.MERRA2['2010':],cf_NEm.wp_obs['2010':],False),
                          'MERRA2_GWA':stats(cf_NEm.MERRA2_GWA['2010':],cf_NEm.wp_obs['2010':],False),
                          'obs':[np.nan,np.nan,np.nan,cf_NEm.wp_obs['2010':].mean()]},
                         index = ['cor','rmse','mbe','avg'])
stats_NEm_r = pd.DataFrame({'ERA5':stats(cf_NEm.ERA5['2010':],cf_NEm.wp_obs['2010':]),
                            'ERA5_GWA':stats(cf_NEm.ERA5_GWA['2010':],cf_NEm.wp_obs['2010':]),
                            'MERRA2':stats(cf_NEm.MERRA2['2010':],cf_NEm.wp_obs['2010':]),
                            'MERRA2_GWA':stats(cf_NEm.MERRA2_GWA['2010':],cf_NEm.wp_obs['2010':]),
                            'obs':[np.nan,np.nan,np.nan,round(cf_NEm.wp_obs['2010':].mean(),2)]},
                           index = ['cor','rmse','mbe','avg'])
# save statistical results
stats_NEm.to_csv(results_pathg+'/stats_NEm2010.csv')
stats_NEm_r.to_csv(results_pathg+'/stats_NEm_r2010.csv',sep=';')
