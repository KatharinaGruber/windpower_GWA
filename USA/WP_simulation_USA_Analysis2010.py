...
def analyse_regionsm(region,rd=False):
    ...
    # Analyse
    stats_regm = pd.DataFrame({'ERA5':stats(cf_regm.ERA5['2010':],cf_regm.wp_obs['2010':],rd),
                               'ERA5_GWA':stats(cf_regm.ERA5_GWA['2010':],cf_regm.wp_obs['2010':],rd),
                               'MERRA2':stats(cf_regm.MERRA2['2010':],cf_regm.wp_obs['2010':],rd),
                               'MERRA2_GWA':stats(cf_regm.MERRA2_GWA['2010':],cf_regm.wp_obs['2010':],rd),
...
def analyse_statesm(state,rd = False):
    ...
    stats_stm = pd.DataFrame({'ERA5':stats(cf_stm.ERA5['2010':],cf_stm.wp_obs['2010':],rd),
                              'ERA5_GWA':stats(cf_stm.ERA5_GWA['2010':],cf_stm.wp_obs['2010':],rd),
                              'MERRA2':stats(cf_stm.MERRA2['2010':],cf_stm.wp_obs['2010':],rd),
                              'MERRA2_GWA':stats(cf_stm.MERRA2_GWA['2010':],cf_stm.wp_obs['2010':],rd),
...
stats.to_csv(results_pathg + '/stats_GWA'+str(GWA)+'.csv')