...
if usa_path + "/turbine_data.csv" not in glob.glob(usa_path + '/*.csv'):
...
turbine_data = pd.read_csv(usa_path + "/turbine_data.csv", index_col = [0,1])

# MERRA data preparation
##########################
if usa_path + '/turbine_data_mer_gwa' + GWA + '.csv' not in glob.glob(usa_path + '/*.csv'):
    ...
    turbine_data_mer_gwa.to_csv(usa_path + '/turbine_data_mer_gwa' + GWA + '.csv')
    turbine_data_era.to_csv(usa_path + '/turbine_data_era.csv')
    turbine_data_era_gwa.to_csv(usa_path + '/turbine_data_era_gwa' + GWA + '.csv')
    ...
    labels.to_csv(usa_path + '/labels_turbine_data_gwa' + GWA + '.csv')